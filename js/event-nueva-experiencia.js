/* KPK Wellness — Nueva Experiencia Culinaria (DRAFT) JS */
/* TODO: actualizar el mensaje de WhatsApp y el nombre del evento al definir la nueva fecha. */
const WA_NUMBER = '526643640788';
const WA_MSG = encodeURIComponent('Hola, quiero información para reservar mi lugar en la próxima experiencia culinaria de KPK Wellness en Playas de Tijuana.');
...
async function handleEventForm(e) {
  ...
  const data = {
    ...
    evento: 'Nueva Experiencia Culinaria — [FECHA POR DEFINIR]',
